...
@Component({
  selector: 'app-starterspk-content',
  templateUrl: './starterspk-content.component.html',
  styleUrls: ['./starterspk-content.component.css']
})
export class StarterSpkContentComponent implements OnInit {

persons: Array<any>= [ 
  { "customerId": "Aaron Moore", "kodeCabang": "123213213123", "job  itle": "Regional Configuration Producer", "active": true, "phoneNumber": "611-898-6201", "date": "2015-11-06","tanggalLahir": "2010-11-06" },
